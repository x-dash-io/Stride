import { PrismaClient, ProductStatus, GenderCategory, OrderStatus, PaymentStatus, ProductTag } from '@prisma/client'
...
async function main() {
  ...
  const productsData = [
    ...
    },
    {
      ...
      tag: ProductTag.LIMITED_EDITION,
      weightKg: 1.3,
      variants: [
